                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p style='color:black; font-weight:bold'><?= $this->params['userInfo']['user_name'] .
                                                                             ' ' .
                                                                             $this->params['userInfo']['user_surname'] ?></p>
                                <p>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <div style="padding: 8px; color: red;"> <?= Yii::t('app', 'Admin Mode') ?></div>
                                </div>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p><?= $this->params['userInfo']['user_name'] . ' ' .
                           $this->params['userInfo']['user_surname'] ?></p>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="/rep">
                        <i class="fa fa-exclamation-triangle"></i> <span><?= Yii::t('app', 'Reports') ?></span>
                    </a>
                </li>
