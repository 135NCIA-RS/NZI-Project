...
JS;
					...
					{
						echo Html::beginForm(["users/view", 'uname' => $user->getUsername()], 'post',
								['data-pjax' => '']);
								...
								<div class="post">
									<div class="user-block">
                                        ...
                                        <span class="username">
                                            ...
                                            <input class="" type="hidden" name="type" value="delete_post"
                                                   id="delete_post-form">
                                            <button style="border: none; margin-top: 2px" type="submit"
									...
									<ul class="list-inline">
										<li><a href="#" class="link-black text-sm"><i
														...
														'Share'); ?></a></li>
										<li>
											<?php echo Html::beginForm(["users/view", 'uname' => $user->getUsername()],
													'post', ['data-pjax' => '']) ?>
											<input type="hidden" name="post_id" value="<?= $row->getId() ?>">
											...
											<input class="" type="hidden" name="type" value="like" id="like-form">
                                                    <span class="link-black text-sm">
                                                        ...
                                                        <input type="submit"
                                                               class="fa fa-t humbs-o-up link-black text-sm"
												...
												<p class="message">
													<a href="#" class="name">
														<small class="text-muted pull-right">
															<?= Html::beginForm(["users/view",
															                     'uname' => $user->getId()], 'post',
																	['data-pjax' => '']) ?>
