...
/* @var $content string */
/* @var $userData \common\components\IntouchUser */
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header"><?= Yii::t('app',
                                        'You have'); ?> <?= $this->params['notification_count'] ?> <?= Yii::t('app',
                                        'notification(s)'); ?></li>
                            <li>
                                    ...
                                    <li>
                                        ...
                                        if ($this->params['notification_count'] > 0)
                                        {
                                            ...
                                            <a href="/notifications">
                                                <i class="fa fa-users text-aqua"></i> <?= Yii::t('app',
                                                        'New friend request'); ?>
                                            </a>
                                            <?php
                                        }
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <?= Html::img($userData->getImageUrl(),
                                        ['class' => 'img-circle', 'alt' => 'User Image']) ?>
                                <p style='color:black; font-weight:bold'><?= $userData->getFullName() ?></p>
                                <p>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/profile" class="btn btn-default btn-flat"><?= Yii::t('app',
                                                'Profile'); ?></a>
                                </div>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <?= Html::img($userData->getImageUrl(), ['class' => 'img-circle', 'alt' => 'User Image']) ?>
                </div>
                <div class="pull-left info">
                    <p><?= $userData->getFullName() ?></p>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        {
                            echo '<li><a href="/action/lang?lang=' . $key . '"><i class="flag-icon flag-icon-' . $key .
                                 '"></i>' . ' | ' . $lang . '</a></li>';
                        }
                        ?>
                    </ul>
