            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                        ...
                        <button style="width:20%; margin-top:5px;" type="submit" class="btn btn-danger pull-right btn-primary btn-sm" ><?= Yii::t('app','Publish'); ?></button><br>
                        <hr>
                        <?= Html::endForm() ?>
                        <!-- /Add post-->
                        <!-- Post -->
                        ...
                        <div class="box box-warning">
                            ...
                            <form enctype="multipart/form-data" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?= Yii::t('app','Change profile picture'); ?></label>
                                        <input type="file" name="exampleInputFile">
                                        <p class="help-block"><?= Yii::t('app','Must be less than 300kb and in one of the following formats: png, jpg.'); ?></p>
                                    </div>
